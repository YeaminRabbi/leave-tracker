                    ...
                    @if (Auth::user()->hasrole('admin'))
                        ...
                        <li class="menu-item {{ Request::routeIs('admin.applications.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.applications') }}" class="menu-link">
                                ...
                                <div data-i18n="Analytics">Leave Application</div>
                            </a>
                        </li>
                    @endif

                    @if (Auth::user()->hasrole('employee'))
                        <li class="menu-item {{ Request::routeIs('leave-application.*') ? 'active' : '' }}">
                            <a href="{{ route('leave-application.index') }}" class="menu-link">
                                <i class="menu-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                © {{ date('Y') }}, developed with <i class="fa fa-heart" style="color: red;"></i>
                                by <a href="https://yeaminrabbi.techstringit.com/" target="_blank"
                                    class="footer-link fw-bolder">Yeamin Rabbi</a>
                            </div>
